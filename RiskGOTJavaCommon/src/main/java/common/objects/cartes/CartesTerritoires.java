...
public class CartesTerritoires {
    ...
    {
        //North (13)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.SKAGOS), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.KARHOLD), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.FORT_TERREUR), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.WINTERFELL), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.BLANCPORT), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.ROCHES), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.CAP_KRAKEN), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.VIVESAIGUES), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.PIERRE_MOUTIER), CarteTerritoire.UniteSpeciale.FORTIFICATION));

        //Iron Islands (2)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.HARLOI), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //Westerlands (5)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.FALAISE), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.LA_DENT_DOR), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.CASTRAL_ROC), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //Vale of Arryn (4)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.MONTAGNES_DE_LA_LUNE), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.LES_EYRIE), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.GOEVILLE), CarteTerritoire.UniteSpeciale.FORTIFICATION));

        //Crownlands (4)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.PRESQU_ILE_DE_CLAQUEPINCE), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.BOIS_DU_ROI), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.BOIS_LA_PLUIE), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //Bief(4)
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.ROUTE_DE_LOCEAN), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.MANDER), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.HAUTJARDIN), CarteTerritoire.UniteSpeciale.FORTIFICATION));
        ...
        //cartesTerritoires.add(new CarteTerritoire(territoires.getTerritoireParNom(Territoire.TerritoireNames.SANG_VERT), CarteTerritoire.UniteSpeciale.FORTIFICATION));
